# Original SimPy2.7 made heavy use of the Canvas.py module that came with
# Tkinter.  Note in it says it was an experiment and is not obsolete.
# Whilst we are doing the port to the Python 3 for SimPy plot (an maybe GUI)
# it has been included here as a temporary measure.
