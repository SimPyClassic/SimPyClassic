...
# $Revision: 1.1.1.32 $ $Date: 2008/03/03 13:54:26 $ kgm
"""SimulationTrace 1.9.1 Traces execution of SimPy models.
...
**Change history:**
    ...
    09 Jun 2007: - Enabled tracing of "activate" and "passivate".
                 - Cleaned out all uses of "object" to prevent name clash.
...
"""
__TESTING=False
version=__version__="1.9.1 $Revision: 1.1.1.32 $ $Date: 2008/03/03 13:54:26 $"
if __TESTING: 
...
class Process(Lister):
    ...
    def start(self,pem=None,at="undefined",delay="undefined",prior=False):
        ...
        if not self._terminated and not self._nextTime: 
            ...
            trace.recordActivate(who=self,when=zeit,prior=prior)
...
def activate(obj,process,at="undefined",delay="undefined",prior=False):
    ...
    if not obj._terminated and not obj._nextTime:
        ...
        if delay=="undefined":
            ...
            zeit=max(_t,_t+delay)
        trace.recordActivate(who=obj,when=zeit,prior=prior)
...
def reactivate(obj,at="undefined",delay="undefined",prior=False):
    ...
    if not obj._terminated:
        ...
        if delay=="undefined":
            ...
            zeit=max(_t,_t+delay)
        trace.recordReactivate(who=obj,when=zeit,prior=prior)
        _e._post(obj,at=zeit,prior=prior)
